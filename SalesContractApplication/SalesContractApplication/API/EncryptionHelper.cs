...
namespace SalesContractApplication.API
{
    ...
    {
        private static readonly string encryptionKey = "gnoht";
        ...
        public static string Encrypt(string toEncrypt, bool useHashing = true, string key = "")
        {
            ...
            tdes.Clear();
            return Convert.ToBase64String(resultArray, 0, resultArray.Length).TrimEnd('\b');
        }
        /// <summary>
        ...
        public static string Decrypt(string cipherString, bool useHashing, string key = "")
        {
            ...
            tdes.Clear();
            return UTF8Encoding.UTF8.GetString(resultArray).TrimEnd('\b');
        }
    }
}